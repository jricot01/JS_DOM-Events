...
let headerThrees = document.getElementsByTagName("h3");
for (let h3 of headerThrees) {
  h3.textContent =
...
anchorTag.insertBefore(anchorTag, newParagraph);
/*----------- Exercise #3: REMOVING/REPLACING ELEMENTS/OBJECTS -----------*/

// TODO: Replace the "Child Node" with a new <p> element that reads "New Child Node"
let exercisecontainer3 = document.querySelector("#exercise-container3");
...
let newNode = document.querySelector("p");
newNode.replaceChild(N2, N1);
...
// {/* <button id="btn">View Modal</button>
